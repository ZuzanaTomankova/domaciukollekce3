...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Průměrný počet hostů "+bookingManager.getAverageGuests());
    ...
    //  System.out.println("-----------------------------------------------");
    //System.out.println("Průměrný počet rezervací na jednoho hosta: " + guestList.size()/(double) (bookingList.size() +
    //      otherGuests.size()) );
    //}
